...
app.post('/api/reel/post',async(req,res)=>{try{
  ...
  try{const gen=await azure.generateContent(`Write a 1-2 sentence Facebook reel caption about: ${topic}. Include 3-5 relevant hashtags.`,{maxTokens:500});if(gen&&gen.length>5)content=gen;}catch(e){console.error('[reel] gen failed:',e.message);}
