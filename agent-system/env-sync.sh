...
SERVICE_ENV=(
  ...
  "SUPABASE_URL SUPABASE_SECRET_KEY REDIS_URL AZURE_OPENAI_API_KEY AZURE_OPENAI_ENDPOINT AZURE_SPEECH_KEY AZURE_SPEECH_REGION FACEBOOK_ACCESS_TOKEN FACEBOOK_PAGE_ID JINA_API_KEY PIXABAY_API_KEY"
)
