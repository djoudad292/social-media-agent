...
SERVICE_ENV=(
  ...
  "SUPABASE_URL SUPABASE_SECRET_KEY REDIS_URL AZURE_OPENAI_API_KEY AZURE_OPENAI_ENDPOINT FACEBOOK_ACCESS_TOKEN FACEBOOK_PAGE_ID JINA_API_KEY PIXABAY_API_KEY"
)
