...
SERVICE_ENV=(
  "SUPABASE_URL SUPABASE_SECRET_KEY REDIS_URL TELEGRAM_BOT_TOKEN OPENCLAW_GATEWAY_TOKEN FACEBOOK_ACCESS_TOKEN AZURE_OPENAI_API_KEY AZURE_OPENAI_ENDPOINT"
  ...
  "SUPABASE_URL SUPABASE_SECRET_KEY REDIS_URL AZURE_OPENAI_API_KEY AZURE_OPENAI_ENDPOINT FACEBOOK_ACCESS_TOKEN FACEBOOK_PAGE_ID JINA_API_KEY"
)
